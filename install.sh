#!/usr/bin/env sh
# Universal installer for ossaudit. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/ossaudit.git"
